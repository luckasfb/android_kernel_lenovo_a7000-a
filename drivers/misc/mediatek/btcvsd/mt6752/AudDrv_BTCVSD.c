...
static int AudDrv_btcvsd_Free_Buffer(struct file *fp, kal_uint8 isRX)
{
    ...
    if (isRX == 1)
    {
        if ((BT_CVSD_Mem.pucRXVirtBufAddr != NULL) && (BT_CVSD_Mem.pucRXPhysBufAddr != 0))
        {
            ...
            btsco.pRX =  NULL;
	    /*Lenovo-sw zhangxt4 modify 20150108, use an actual device structure, or __dma_free_coherent() will return directly*/
            dma_free_coherent(mDev, BT_CVSD_Mem.u4RXBufferSize, BT_CVSD_Mem.pucRXVirtBufAddr, BT_CVSD_Mem.pucRXPhysBufAddr);
    ...
    else
    {
        if ((BT_CVSD_Mem.pucTXVirtBufAddr != NULL) && (BT_CVSD_Mem.pucTXPhysBufAddr != 0))
        {
            ...
            btsco.pTX =  NULL;
            /*Lenovo-sw zhangxt4 modify 20150108, use an actual device structure, or __dma_free_coherent() will return directly*/
            dma_free_coherent(mDev, BT_CVSD_Mem.u4TXBufferSize, BT_CVSD_Mem.pucTXVirtBufAddr, BT_CVSD_Mem.pucTXPhysBufAddr);
            /*Lenovo-sw zhangxt4 modify end.*/
