...
/*
 *Lenovo-sw zhangxt4 modify, 20150108
 *kal_uint32 is 32bit, but dma_xxx_coherent() handles 64bit args.
 *pucTXVirtBufAddr will be rinsed when 32bit args transfer to 64bit.
 */
typedef struct
{
    ...
    size_t u4TXBufferSize;
    size_t u4RXBufferSize;
} CVSD_MEMBLOCK_T;
