...
static struct alsps_hw cust_alsps_hw = {
	...
	/* lenovo-sw youwc1 20150127: adapter psensor for different project start */
    .ps_threshold_high_offset = 302,
    .ps_threshold_low_offset = 112,
	/* lenovo-sw youwc1 20150127: adapter psensor for different project end */
};
