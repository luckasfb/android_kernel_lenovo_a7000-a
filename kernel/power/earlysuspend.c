...
/* lenovo.sw begin chenyb1 20141023. add for suspend debug */
	pm_warn("early_suspend done!\n");
/* lenovo.sw end chenyb1 20141023. add for suspend debug */
 abort:
...
#else
/* lenovo.sw begin chenyb1 20141023. add for suspend debug */
		pm_warn("calling pm_autosleep_set_state() into mem\n");
/* lenovo.sw end chenyb1 20141023. add for suspend debug */
